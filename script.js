const data = {
    OVERALL: [
        { place: 1, nick: 'Пусто', tiers: [{type:'uhc',label:'empty'},{type:'sword',label:'empty'}], score: 0, avatar: 'places/overall_1.png' },
    ...
    SWORD: [
        { place: 1, nick: 'Пусто', tiers: [{type:'sword',label:'empty'}], score: 0, avatar: 'places/sword_1.png' },
